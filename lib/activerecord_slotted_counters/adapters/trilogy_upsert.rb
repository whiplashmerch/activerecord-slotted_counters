  ...
  module Adapters
    class TrilogyUpsert
      ...
      def apply?(current_adapter_name)
        return false unless defined?(ActiveRecord::ConnectionAdapters::TrilogyAdapter)

        current_adapter_name == ActiveRecord::ConnectionAdapters::TrilogyAdapter::ADAPTER_NAME
      end
